...
| 38 | Denodo event log — `bookmark_by_icon` when bookmarking with `☆` icon | [TC_038](./TC_038.md) |
...
**Pending your review (Sanjay):** [PENDING_REVIEW.md](./PENDING_REVIEW.md) — **Automation ID** / **Grade** set (**TC_021:** C10000, D; **TC_022:** SMS_TEMP_001, D); remaining checklist items as needed. **TC_023:** C00129, D; **TC_024:** C00131, D; **TC_025:** C00163, D; **TC_026:** C00322, D; **TC_027:** C00323, D; **TC_028:** C00077, D; **TC_029:** C00101, D; **TC_030:** C00239, D; **TC_031:** C00628, D; **TC_032:** C00629, D; **TC_033:** C00630, D; **TC_034:** C00631, D; **TC_035:** C00632, D; **TC_037:** ARCH_TEMP_002, D; **TC_038:** C00644, C; **TC_039:** C00645a, C; **TC_040:** C00646, C (ARCH).

**Adding more test cases:** Create `TC_041.md`, … in this folder and add a row above for each. For each new test case, provide **Automation ID** (e.g. C00549) and **Grade** (e.g. D) so they can be included in the document.

**Drafts:** Edit formal `TC_NNN.md` after promotion. **KFS push** (**TC_034**) and **KFS snack bar** (**TC_035**): no companion `DRAFT_ARCH_KFS_Notification_*` files unless Sanjay asks for one. **Pointers (entry points):** [DRAFT_SMS_Manual_Delivery_Titan_ISS.md](./DRAFT_SMS_Manual_Delivery_Titan_ISS.md), [DRAFT_SMS_Duplicate_Alert_AutoStop.md](./DRAFT_SMS_Duplicate_Alert_AutoStop.md) → **TC_021** / **TC_022**. **KFS snack bar** is finalised as **TC_035** — no companion draft unless Sanjay asks. Update this README when that list changes.
